...
#' 0.0.0.9004\cr Date: \tab 2021-08-10\cr License: \tab GPL-3\cr LazyLoad: \tab
#' yes\cr }
...
#' significance test for evaluating differences in Pearson Product-Moment
#' Correlation coefficients.  The package is intended for usage by students in
#' the APSY510/511 classes.
#'
#' @name bcdstats-package
#' @aliases bcdstats bcdstats-package
#' @docType package
#'
